...
import about from "../../../../../public/image/banner-remove-bg/about-img-1.webp";
import icon from "../../../../../public/image/icon/icon.png";
import icon_1 from "../../../../../public/image/icon/icon_1_.png";
import icon_2 from "../../../../../public/image/icon/icon_2_.png";
const Introduce = () => {
  return (
    <>
