...
const Footer = () => (
  <div className="footer bg-footer w-full ">
    <div className="main-feature flex justify-between p-12">
      <div className="main-feature-box text-center group">
    ...
    <div className="footer-info border-t-1 border-b-1 border-gray-600 text-white p-12 flex">
      <div className="footer-left flex p-3 w-70p">
        <div className="footer-help flex-1">
        ...
        <div className="footer-left-center flex-1 ml-12 mr-12 ">
        ...
        <div className="footer-content-right flex-1">
      ...
      <div className="footer-right w-30p flex justify-end p-3 border-l-1 border-gray-600">
        <div>
          ...
          <div className="form-info relative">
            <InputForm fullWidth className="pl-12 border-none text-blue-ct7 py-4 font-semibold text-sm" placeholder="Your email address..." />
            <Email className="absolute -translate-y-2/4 top-2/4 left-2 w-10 h-10 text-blue-ct6" />
            <Button types="success" className="absolute right-2 -translate-y-2/4 top-2/4 py-3 ">
              SUBSCRIBE
            </Button>
          </div>
        </div>
