...
<CardHeader>
  ...
  <CardDescription className="text-gray-500 text-xs">Fresh meat</CardDescription>
</CardHeader>
<CardContent>
  <p className="text-ctBlue7 text-sm font-medium mt-2 mb-2">Chicken form USA</p>
</CardContent>
<CardFooter>
  <h4>
...
<CardContent>
  ...
  <div
    className="sale bg-red-600 text-white z-0 absolute top-1
